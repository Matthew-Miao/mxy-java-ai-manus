...
import com.mxy.ai.manus.dynamic.mcp.model.vo.McpConfigRequestVO;
import com.mxy.ai.manus.dynamic.mcp.model.vo.McpServerConfig;
import com.mxy.ai.manus.dynamic.mcp.model.vo.McpServersConfig;
import com.mxy.ai.manus.dynamic.mcp.model.vo.McpServiceEntity;
import com.mxy.ai.manus.dynamic.mcp.repository.McpConfigRepository;
...
public class McpService implements InitializingBean {
    ...
    private List<McpConfigEntity> insertOrUpdateMcpRepo(McpConfigRequestVO mcpConfigVO) throws IOException {
